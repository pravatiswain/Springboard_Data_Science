...
WHERE LEFT(Bookings.starttime, 10) = '2012-09-14'
      AND ((Bookings.memid = 0) AND (Facilities.guestcost*Bookings.slots > 30.0)
      OR (Bookings.memid != 0) AND (Facilities.membercost*Bookings.slots > 30.0))
